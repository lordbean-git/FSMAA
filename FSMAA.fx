...
technique SMAA
< ui_tooltip =	"Fast SMAA skips most of the enhanced features of the shader in order to\n"
		"apply its basic effect to the scene with a very low overhead.\n\n"
		"There are no changes to any of the core enhanced SMAA code, only the\n"
		"addition of one built-in pre-processor define plus one new one I created.\n"
		"This shader can be reverted to full enhanced SMAA by deleting the 2 added\n"
		"pre-processor defines if so desired. This UI tooltip is the ONLY new\n"
		"piece of code in the shader."; >
{
#ifndef SMAA_DISABLE_DEPTH_BUFFER
